...
export default function Sidebar({
  ...
  const handleMouseEnter = () => {
    ...
    controlledSetHovered?.(true);
  };

  const handleMouseLeave = () => {
    setInternalHovered(false);
    controlledSetHovered?.(false);
  };
  ...
  return (
    <>
      ...
      <aside
        ...
        style={{
          width: isExpanded || mobileOpen ? '230px' : '72px',
      ...
      >
          ...
          >
            ...
            {isExpanded && (
              <div style={{ display: 'flex', flexDirection: 'column', animation: 'fadeIn 0.2s ease' }}>
                <span style={{ fontWeight: 800, fontSize: '18px', color: '#0f172a', letterSpacing: '-0.3px', lineHeight: 1.1 }}>
                  Cohort
                </span>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: isActive ? '#ffffff' : '#556477',
                    boxShadow: isActive ? '0 4px 12px rgba(32, 96, 232, 0.28)' : 'none',
                  }}
                  onMouseEnter={(e) => {
                    if (!isActive) {
                  ...
                  onMouseLeave={(e) => {
                    if (!isActive) {
                      ...
                      (e.currentTarget as HTMLButtonElement).style.color = '#556477';
                    }
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Icon
                        ...
                        style={{ color: isActive ? '#ffffff' : 'inherit', flexShrink: 0 }}
                      />

                      {/* Dot badge when collapsed */}
                      {!isExpanded && item.badge && item.badgeType === 'circle' && !isActive && (
                        <span
                          style={{
                            position: 'absolute',
                            top: '-6px',
        ...
        {/* Bottom Section: Theme Toggle & User Account / Logout */}
        <div
          style={{
        ...
        >
          ...
          {user && (
            isExpanded ? (
              ...
              <button
                onClick={signOut}
                title={`Sign out (${profile?.full_name || 'User'})`}
                style={{
                  width: '40px',
                  height: '40px',
                  borderRadius: '50%',
